...
//namespace Long {
//
//	// tinygltf image callback: decode embedded PNG/JPEG with raylib's stb (the
//	// only stb implementation in the engine). Required because of
//	// TINYGLTF_NO_STB_IMAGE -- without a callback tinygltf fails on any model
//	// that contains textures.
...
//				}
//				::UploadMesh(&m, false); 
//				out.meshIds.push_back(assets.AddMesh(m));
